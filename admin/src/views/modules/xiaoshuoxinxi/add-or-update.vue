	...
	<div class="addEdit-block" :style='{"padding":"30px 50px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="作者姓名" prop="zuozhexingming">
					<el-input v-model="ruleForm.zuozhexingming" placeholder="作者姓名" clearable  :readonly="ro.zuozhexingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="作者姓名" prop="zuozhexingming">
